...
MOEX_SYMBOLS = ["NG-8.23", "NG-9.23","GOLD-9.23","BR-9.23"]
...
# IQFeed symbols:
IQFEED_SYMBOLS = ["QNGU23", "QNGV23", "QMGCZ23", "QBZV23"] # COMEX / GOLD / QMGCQ23 - no subscription. IB data should be used
...
NYMEX_CONTRACTS = [Future(symbol = "NG",lastTradeDateOrContractMonth = "20230829",exchange = "NYMEX",localSymbol = "NGU3",currency = "USD"),
                 Future(symbol = "NG",lastTradeDateOrContractMonth = "20230927",exchange = "NYMEX",localSymbol = "NGV3",currency = "USD"),
                 Future(symbol = "MGC",lastTradeDateOrContractMonth = "20231227",exchange = "COMEX",localSymbol = "MGCZ3",currency = "USD"),
                 Future(symbol = "BZ",lastTradeDateOrContractMonth = "20230831",exchange = "NYMEX",localSymbol = "BZV3",currency = "USD")]
